...
namespace SoleAuthenticity_Ver2.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        [ProducesResponseType((int)HttpStatusCode.BadRequest)]
        public async Task<ActionResult<ServiceResponse<CategoryDto>>> CreateNewCategory([FromBody]Category category)
        {
            try
            {
        ...
        [ProducesResponseType((int)HttpStatusCode.NoContent)]
        [ProducesResponseType((int)HttpStatusCode.BadRequest)]
        public async Task<ActionResult<ServiceResponse<string>>> UpdateCategory(int id, [FromBody]Category category)
        {
            try
            {
